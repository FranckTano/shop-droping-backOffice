...
@Component({
    selector: '[app-topbar]',
    standalone: true,
	imports: [RouterModule, CommonModule, StyleClassModule, FormsModule, Ripple, ButtonModule, MegaMenuModule, BadgeModule, OverlayBadge, Image, SafeStyleClassDirective],
